...
const Connection = async (username, password) => {
    ...
    const URL = `mongodb://${username}:${password}@ac-rhtoovw-shard-00-00.ihgqi7w.mongodb.net:27017,ac-rhtoovw-shard-00-01.ihgqi7w.mongodb.net:27017,ac-rhtoovw-shard-00-02.ihgqi7w.mongodb.net:27017/ecommerceSite?ssl=true&replicaSet=atlas-ce2kzq-shard-0&authSource=admin&retryWrites=true&w=majority`
    try {
